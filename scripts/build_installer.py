...
INSTALLER_FILENAMES = {
    "Windows": "DeadlineCloudForHoudiniSubmitter-windows-x64-installer.exe",
    "Linux": "DeadlineCloudForHoudiniSubmitter-linux-x64-installer.run",
    "MacOS": "DeadlineCloudForHoudiniSubmitter-osx-installer.app",
}
