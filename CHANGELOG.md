...
* Fixed AWS Console sign-in failing to authenticate from the submitter. The minimum `deadline` dependency has been bumped to 0.60.4 with the `console` extra, ensuring `awscrt` is properly included and loadable in the bundled submitter. (#394)
