...
from deadline_adaptor_for_houdini.HoudiniClient.houdini_client import HoudiniClient, main


class TestHoudiniClient:
    @patch("deadline_adaptor_for_houdini.HoudiniClient.houdini_client.HTTPClientInterface")
    ...
    @patch("deadline_adaptor_for_houdini.HoudiniClient.houdini_client.os.path.exists")
    @patch.dict(os.environ, {"HOUDINI_ADAPTOR_SOCKET_PATH": "socket_path"})
    @patch("deadline_adaptor_for_houdini.HoudiniClient.HoudiniClient.poll")
    @patch("deadline_adaptor_for_houdini.HoudiniClient.houdini_client.HTTPClientInterface")
