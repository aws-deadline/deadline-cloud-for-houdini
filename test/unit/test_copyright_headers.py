...
class FileMissingCopyrightException(Exception):
    filepath: Path
...
def _check_file(filename: Path) -> None:
    with open(filename) as infile:
        ...
        for line in infile:
            ...
            lines_read += 1
            if lines_read > 10:
                raise FileMissingCopyrightException(
